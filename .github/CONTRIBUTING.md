...
Thank you for your interest in contributing to the Internet Computer SMTP Gateway Protocol repository.
...
- If you want to report an issue, click [issues](https://github.com/dfinity/ic-smtp-gateway-protocol/issues).
- If you have more general questions related to this project and its use, post a message to the [community forum](https://forum.dfinity.org/).
...
1. Click [create a new issue](https://github.com/dfinity/ic-smtp-gateway-protocol/issues/new).
...
2. Navigate to the [repository's homepage](https://github.com/dfinity/ic-smtp-gateway-protocol) in a web browser.
...
8. Commit your changes to store the contents you added to the index along with a descriptive message by running a command similar to the following:
   ```shell
   git commit -m "type: a descriptive commit message"
   ```
